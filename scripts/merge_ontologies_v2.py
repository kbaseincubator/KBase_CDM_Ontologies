...
def merge_ontologies(
    ...
    """
    Merge multiple ontology files using ROBOT tool with special handling for EC codes and UniProt references.
    """
    try:
        # Set up paths
        ...
        with open(mapping_file, 'w') as f:
            f.write('https://bioregistry.io/eccode: EC:\n')
            f.write('https://bioregistry.io/uniprot: UP:\n')
        ...
        annotate_command = [
            ...
            '--prefix', 'EC: http://purl.obolibrary.org/obo/EC_',
            '--prefix', 'eccode: http://purl.obolibrary.org/obo/EC_',
            '--prefix', 'UP: http://purl.uniprot.org/uniprot/',
            '--output', intermediate_file2
        ]
